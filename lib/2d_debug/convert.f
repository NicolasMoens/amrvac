...
subroutine calc_x(igrid,xC,xCC)
  ...
  if(stretched_grid) then
    if(slab_stretched) then
      xC(ixCmin1:ixCmax1,ixCmin2:ixCmax2,2)=pw(igrid)%x(ixCmin1:ixCmax1,&
         ixCmin2:ixCmax2,2)+0.5d0*pw(igrid)%dx(ixCmin1:ixCmax1,ixCmin2:ixCmax2,&
         2)
    else
      xC(ixCmin1:ixCmax1,ixCmin2:ixCmax2,1)=pw(igrid)%x(ixCmin1:ixCmax1,&
         ixCmin2:ixCmax2,1)+0.5d0*pw(igrid)%dx(ixCmin1:ixCmax1,ixCmin2:ixCmax2,&
         1)
    end if
  end if
