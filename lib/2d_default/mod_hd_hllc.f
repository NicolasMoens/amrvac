  ...
  subroutine hd_get_lCD(wLC,wRC,fLC,fRC,cmin,cmax,idim,ixImin1,ixImin2,ixImax1,&
    ...
    do iw=1,nwflux
       where(Cond_patchf(ixOmin1:ixOmax1,ixOmin2:ixOmax2))
          ...
          Fhll(ixOmin1:ixOmax1,ixOmin2:ixOmax2,iw)= (cmax(ixOmin1:ixOmax1,&
             ...
             iw)-wLC(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             iw)))/(cmax(ixOmin1:ixOmax1,ixOmin2:ixOmax2)-cmin(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2))
          ...
          whll(ixOmin1:ixOmax1,ixOmin2:ixOmax2,iw) = (cmax(ixOmin1:ixOmax1,&
             ...
             iw)-fRC(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             iw))/(cmax(ixOmin1:ixOmax1,ixOmin2:ixOmax2)-cmin(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2))
       endwhere
    enddo
    ...
    where(Cond_patchf(ixOmin1:ixOmax1,ixOmin2:ixOmax2))
       ...
       elsewhere(cmax(ixOmin1:ixOmax1,ixOmin2:ixOmax2) > zero .and. &
          ...
          zero.and.lambdaCD(ixOmin1:ixOmax1,&
    ...
    if(flathllc)then
       ...
       where(Cond_patchf(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2).and. dabs(lambdaCD(ixOmin1:ixOmax1,&
          ixOmin2:ixOmax2))/max(cmax(ixOmin1:ixOmax1,ixOmin2:ixOmax2),&
      ...
      if(abs(patchf(ix1,ix2))==1) then
        ...
        do iw=1, ndir
          if(iw /= idim)then
            ...
            wCD(ix1,ix2,mom(iw))=(cspeed(ix1,ix2)*wSub(ix1,ix2,&
               mom(iw))-fSub(ix1,ix2,mom(iw)))/(cspeed(ix1,ix2)-lambdaCD(ix1,&
               ix2))
          else
            ! eq. 20
        ...
        if(hd_energy) then
          ...
          wCD(ix1,ix2,e_) = (cspeed(ix1,ix2)*wSub(ix1,ix2,e_) -fSub(ix1,ix2,&
             e_)+lambdaCD(ix1,ix2)*pCD(ix1,ix2))/(cspeed(ix1,ix2)-lambdaCD(ix1,&
             ix2))
        end if
