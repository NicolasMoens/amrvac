...
contains
  ...
  subroutine gca_fill_gridvars
    ...
    integer                                   :: idirmin
    double precision, dimension(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:ndir) :: ue,&
        bhat
    ...
    do iigrid=1,igridstail; igrid=igrids(iigrid);
       ...
       absB(ixGlo1:ixGhi1,ixGlo2:ixGhi2) = &
          ...
          dim=ndim+1))
       ue(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1) = gridvars(igrid)%w(ixGlo1:ixGhi1,&
       ...
       ue(ixGlo1:ixGhi1,ixGlo2:ixGhi2,2) = gridvars(igrid)%w(ixGlo1:ixGhi1,&
       ...
       ue(ixGlo1:ixGhi1,ixGlo2:ixGhi2,3) = gridvars(igrid)%w(ixGlo1:ixGhi1,&
       ...
       do idir=1,ndir
         ue(ixGlo1:ixGhi1,ixGlo2:ixGhi2,idir) = ue(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
            idir) * const_c / absB(ixGlo1:ixGhi1,ixGlo2:ixGhi2)**2
       end do

       kappa(ixGlo1:ixGhi1,ixGlo2:ixGhi2) = sqrt(1.0d0 - sum(ue(ixGlo1:ixGhi1,&
          ixGlo2:ixGhi2,:)**2,dim=ndim+1)/const_c**2)
       kappa_B(ixGlo1:ixGhi1,ixGlo2:ixGhi2) = kappa(ixGlo1:ixGhi1,&
          ixGlo2:ixGhi2) * absB(ixGlo1:ixGhi1,ixGlo2:ixGhi2)
       ...
       do idim=1,ndim
         ...
         gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
            grad_kappa_B(idim)) = tmp(ixGlo1:ixGhi1,ixGlo2:ixGhi2)/unit_length
       end do
       ...
       do idir=1,ndir
         ...
         do idim=1,ndim
           ...
           gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
              ...
              ixGlo2:ixGhi2,idim) * tmp(ixGlo1:ixGhi1,&
              ixGlo2:ixGhi2)/unit_length
           gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
              ue_dot_grad_b(idir)) = gridvars(igrid)%w(ixGlo1:ixGhi1,&
              ixGlo2:ixGhi2,ue_dot_grad_b(idir)) + ue(ixGlo1:ixGhi1,&
              ixGlo2:ixGhi2,idim) * tmp(ixGlo1:ixGhi1,&
              ixGlo2:ixGhi2)/unit_length
           call gradient(ue(ixGlo1:ixGhi1,ixGlo2:ixGhi2,idir),ixGlo1,ixGlo2,&
              ixGhi1,ixGhi2,ixGlo1+1,ixGlo2+1,ixGhi1-1,ixGhi2-1,idim,tmp)
           gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
              b_dot_grad_ue(idir)) = gridvars(igrid)%w(ixGlo1:ixGhi1,&
              ixGlo2:ixGhi2,b_dot_grad_ue(idir)) + bhat(ixGlo1:ixGhi1,&
              ixGlo2:ixGhi2,idim) * tmp(ixGlo1:ixGhi1,&
              ixGlo2:ixGhi2)/unit_length
           gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
       ...
       if(time_advance) then
         ! grad(kappa B)
         absB(ixGlo1:ixGhi1,ixGlo2:ixGhi2) = &
            sqrt(sum(gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
            bp(:))**2,dim=ndim+1))
         ue(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1) = &
            gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
            ep(2)) * gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
            bp(3)) - gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
            ep(3)) * gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,bp(2))
         ue(ixGlo1:ixGhi1,ixGlo2:ixGhi2,2) = &
            gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
            ep(3)) * gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
            bp(1)) - gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
            ep(1)) * gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,bp(3))
         ue(ixGlo1:ixGhi1,ixGlo2:ixGhi2,3) = &
            gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
            ep(1)) * gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
            bp(2)) - gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
            ep(2)) * gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,bp(1))
         do idir=1,ndir
           ue(ixGlo1:ixGhi1,ixGlo2:ixGhi2,idir) = ue(ixGlo1:ixGhi1,&
              ixGlo2:ixGhi2,idir) * const_c / absB(ixGlo1:ixGhi1,&
              ixGlo2:ixGhi2)**2
         end do

         kappa(ixGlo1:ixGhi1,ixGlo2:ixGhi2) = sqrt(1.0d0 - &
            sum(ue(ixGlo1:ixGhi1,ixGlo2:ixGhi2,:)**2,dim=ndim+1)/const_c**2)
         kappa_B(ixGlo1:ixGhi1,ixGlo2:ixGhi2) = kappa(ixGlo1:ixGhi1,&
            ixGlo2:ixGhi2) * absB(ixGlo1:ixGhi1,ixGlo2:ixGhi2)
         ...
         do idir=1,ndir
           ! (b dot grad) b and the other directional derivatives
           do idim=1,ndim
             call gradient(bhat(ixGlo1:ixGhi1,ixGlo2:ixGhi2,idir),ixGlo1,&
                ixGlo2,ixGhi1,ixGhi2,ixGlo1+1,ixGlo2+1,ixGhi1-1,ixGhi2-1,idim,&
                tmp)
             gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
    ...
    ! y(ndir+3) = particle(ipart)%self%u(3) ! Lorentz factor of particle
      ...
      if(.not. particle_in_igrid(ipart_working,igrid_working)) then
        ...
        if (pw(igrid_working)%x(ic1,ic2,1) .lt. y(1)) then
           ic11 = ic1
        else
           ic11 = ic1 -1
        end if
        ...
        if (pw(igrid_working)%x(ic1,ic2,2) .lt. y(2)) then
           ic12 = ic2
        else
           ic12 = ic2 -1
        end if
