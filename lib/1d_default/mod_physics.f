...
module mod_physics
  ...
  abstract interface
     ...
     subroutine sub_modify_wLR(wLC, wRC, ixImin1,ixImax1, ixOmin1,ixOmax1,&
         idir)
       use mod_global_parameters
       integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1,&
           idir
     ...
     subroutine sub_get_aux(clipping,w,x,ixImin1,ixImax1,ixOmin1,ixOmax1,&
        subname)
       use mod_global_parameters
       integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1
...
contains
  ...
  subroutine dummy_modify_wLR(wLC, wRC, ixImin1,ixImax1, ixOmin1,ixOmax1,&
      idir)
    use mod_global_parameters
    integer, intent(in)                :: ixImin1,ixImax1, ixOmin1,ixOmax1,&
        idir
  ...
  subroutine dummy_get_aux(clipping,w,x,ixImin1,ixImax1,ixOmin1,ixOmax1,&
     subname)
    use mod_global_parameters
    integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1
    double precision, intent(in)    :: x(ixImin1:ixImax1,1:ndim)
