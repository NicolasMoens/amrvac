...
module mod_usr_methods
  ...
  abstract interface
     ...
     subroutine process_adv_grid(igrid,level,ixImin1,ixImax1,ixOmin1,ixOmax1,&
        qt,w,x)
       use mod_global_parameters
       integer, intent(in)             :: igrid,level,ixImin1,ixImax1,ixOmin1,&
          ixOmax1
     ...
     subroutine special_resistivity(w,ixImin1,ixImax1,ixOmin1,ixOmax1,idirmin,&
        x,current,eta)
       use mod_global_parameters
       integer, intent(in)          :: ixImin1,ixImax1, ixOmin1,ixOmax1,&
           idirmin
     ...
     subroutine transform_w(ixImin1,ixImax1,ixOmin1,ixOmax1,nw_in,w_in,x,&
        w_out)
       use mod_global_parameters
       integer, intent(in)           :: ixImin1,ixImax1, ixOmin1,ixOmax1,&
           nw_in
     ...
     subroutine update_payload(igrid,w,wold,xgrid,xpart,payload,npayload,&
       ...
       double precision, intent(in)  :: xgrid(ixGlo1:ixGhi1,1:ndim),&
          xpart(1:ndir),particle_time
